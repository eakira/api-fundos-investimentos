...
type fundosExternoResponse struct {
	...
	dataCancelamento      string `form:"DT_CANCEL" time_format:"2006-01-02"`
	dataConstituicao      string `form:"DT_CONST" time_format:"2006-01-02"`
	dataFim               string `form:"DT_FIM_EXERC" time_format:"2006-01-02"`
	dataInicio            string `form:"DT_INI_ATIV" time_format:"2006-01-02"`
	dataInicioClasse      string `form:"DT_INI_CLASSE" time_format:"2006-01-02"`
	dataInicioSocial      string `form:"DT_INI_EXERC" time_format:"2006-01-02"`
	dataInicioSituacao    string `form:"DT_INI_SIT" time_format:"2006-01-02"`
	dataPatrimonioLiquido string `form:"DT_PATRIM_LIQ" time_format:"2006-01-02"`
	dataRegistro          string `form:"DT_REG" time_format:"2006-01-02"`
	...
	taxaAdm               string `form:"TAXA_ADM" binding:"max=0,24"`
	taxaPerformance       string `form:"TAXA_PERFM" binding:"max=0,24"`
	tipoFundo             string `form:"TP_FUNDO" binding:"max=20"`
	tributacaoLongoPrazo  string `form:"TRIB_LPRAZO" binding:"max=3"`
	valorPatriminioLiq    string `form:"VL_PATRIM_LIQ" binding:"max=2,24"`
}
